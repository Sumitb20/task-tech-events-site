...
// TASK TECH EVENTS - Single-file React component (Tailwind CSS required)
// - Designed for a modern, high-end, futuristic corporate event agency
// - Uses Tailwind utility classes for layout and responsiveness
// - Replace placeholder images/videos with your high-res assets

export default function TaskTechHomepage() {
  return (
    <div className="min-h-screen font-inter text-gray-100 bg-gradient-to-b from-[#05060a] to-[#071226]">
      ...
      <section className="relative h-screen w-full overflow-hidden">
        ...
        <div className="relative z-20 max-w-7xl mx-auto px-6 lg:px-8 h-full flex items-center">
          <div className="w-full lg:w-3/5 py-24">
            ...
            >
              <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#00E8D4] via-[#0066FF] to-[#E6B800]">Where Industries Meet Innovation</span>
              <span className="block mt-2 text-xl font-medium text-white/80">Summits, Expos, Product Launches and Award Shows — engineered to scale.</span>
            </motion.h2>
            ...
            >
              We design unforgettable industry experiences — immersive stages, premium networking, and seamless production across global venues. Trusted by enterprise leaders and innovators.
            </motion.p>

            <div className="mt-8 flex gap-4">
              <a className="inline-flex items-center gap-3 px-5 py-3 rounded-lg bg-[#0066FF] hover:brightness-110 shadow-2xl font-semibold">Plan an Event</a>
              <a className="inline-flex items-center gap-3 px-5 py-3 rounded-lg border border-white/10 text-white/90">Sponsorship Enquiry</a>
            </div>
          ...
          <div className="hidden lg:block lg:w-2/5 pl-12">
            <div className="rounded-2xl overflow-hidden shadow-2xl ring-1 ring-white/5 bg-gradient-to-br from-white/5 to-white/3 p-1">
              <div className="relative bg-black rounded-xl overflow-hidden">
                <img
                  src="https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=1400&auto=format&fit=crop&ixlib=rb-4.0.3&s=7b701f9a5e8d7f7067b0b9a6c8b1a3e3"
                  alt="expo"
                  className="w-full h-96 object-cover brightness-90"
                />
                <div className="absolute -bottom-6 right-6 w-40 h-40 rounded-full bg-gradient-to-br from-[#00E8D4] to-[#0066FF] blur-3xl opacity-40" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-white/70 mt-2 max-w-xl">End-to-end event production, strategic sponsorships, venue selection, content programming, audience acquisition and full onsite execution.</p>
            </div>
            <a className="hidden md:inline-flex px-4 py-2 rounded-lg border border-white/10">View all services</a>
          </div>
          ...
          <div className="mt-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div key={s.title} whileHover={{ y: -6 }} className="bg-white/3 border border-white/5 rounded-2xl p-6">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-md bg-gradient-to-br from-[#00E8D4] to-[#0066FF] flex items-center justify-center text-black font-bold">{s.icon}</div>
                  <div>
      ...
      <section className="py-20 bg-gradient-to-b from-transparent to-black/50">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          <p className="text-white/70 mt-2 max-w-2xl">Tailored event strategies across IT, Healthcare, Pharma, Fintech, Construction, Electronics and Manufacturing.</p>
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              <div key={sec.name} className="relative rounded-2xl overflow-hidden shadow-lg">
                <img src={`${sec.img}&ixlib=rb-4.0.3&s=placeholder`} alt={sec.name} className="w-full h-48 object-cover brightness-75" />
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[1,2,3,4,5,6,7,8].map((i) => (
              <div key={i} className="rounded-xl overflow-hidden bg-white/3">
                <img src={`https://images.unsplash.com/photo-1551836022-d5d88e9218df?q=80&w=1600&auto=format&fit=crop&ixlib=rb-4.0.3&s=placeholder${i}`} alt={`event-${i}`} className="w-full h-44 object-cover" />
                <div className="p-4">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <div className="lg:col-span-2">
              ...
              <p className="text-white/70 mt-2">Case studies across enterprise launches, largest expo booths and award ceremonies with measurable ROI.</p>

              <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                {[{
                  quote: 'Task Tech delivered a flawless product launch — from stage design to attendee acquisition.',
                  name: 'Head of Product, FinCorp'
                },{
                  quote: 'Our summit saw 3x the engagement we targeted. Seamless execution.',
            ...
            <div>
              <h4 className="text-sm font-semibold text-white/60">Partner & Client Logos</h4>
              <div className="mt-4 grid grid-cols-3 gap-4">
                {['Client A','Client B','Client C','Client D','Client E','Client F'].map((c) => (
                  <div key={c} className="p-3 bg-white/3 rounded-lg text-center text-xs">{c}</div>
                ))}
              </div>

              <div className="mt-6">
                <a className="inline-block px-4 py-3 rounded-lg bg-gradient-to-r from-[#0066FF] to-[#003E9B]">Become a Partner</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 bg-gradient-to-r from-[#003E9B]/30 via-transparent to-[#00E8D4]/10 rounded-2xl p-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div>
              ...
              <p className="text-white/70 mt-2">Connect with our production team for venue scouting, creative programming, sponsorship packages and full onsite delivery.</p>
            </div>
            <div className="flex gap-4">
              <a className="px-5 py-3 rounded-lg bg-[#00E8D4] text-black font-semibold">Request a Proposal</a>
              <a className="px-5 py-3 rounded-lg border border-white/10">Contact Sales</a>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-black/60 border-t border-white/5 py-10">
        <div className="max-w-7xl mx-auto px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded bg-gradient-to-br from-[#0066FF] to-[#00E8D4] flex items-center justify-center">T</div>
              <div>
            ...
            <div className="mt-4 text-sm text-white/60">123 Business Avenue, City • contact@tasktech.events • +91 98765 43210</div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 mt-8 text-xs text-white/60">© {new Date().getFullYear()} TASK TECH EVENTS • All rights reserved</div>
      </footer>
    </div>
  );
}
